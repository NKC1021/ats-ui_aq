    ...
    children: [
      {
        path: 'dashboard',
        name: 'Dashboard',
        component: () => import('~/src/views/index/dashboard/dashboard.vue'),
        meta: {
          title: '看板',
          icon: 'dashboard-line',
        },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/user/departmentManagement/index.vue'),
        meta: {
          title: '部门管理',
          icon: 'group-line',
        },
      ...
      },
      {
        ...
        component: () => import('@/views/user/dictionaryManagement/index.vue'),
        meta: {
          title: '字典管理',
          icon: 'book-2-line',
          dot: true,
      ...
      },
      {
        path: 'taskManagement',
        name: 'TaskManagement',
        component: () => import('@/views/user/taskManagement/index.vue'),
        meta: {
          title: '任务管理',
          icon: 'task-line',
          badge: 'New',
      ...
      },
      {
        path: 'systemLog',
        name: 'SystemLog',
        component: () => import('@/views/user/systemLog/index.vue'),
        meta: {
          title: '系统日志',
