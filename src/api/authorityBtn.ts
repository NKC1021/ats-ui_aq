 ...
 * @returns
 */
export function getAuthorityBtn(data: any) {
  return request({
    url: '/v1/menu/getAuthorityBtn',
    method: 'post',
    data,
  })
}
 ...
 * @returns
 */
export function setAuthorityBtn(data: any) {
  return request({
    url: '/v1/menu/setAuthorityBtn',
    method: 'post',
    data,
  })
}/**
 ...
 * @returns
 */
export function canRemoveAuthorityBtn(data: any) {
  return request({
    url: '/v1/menu/canRemoveAuthorityBtn',
    method: 'post',
    data,
  })
}
