...
export const useUserStore = defineStore('user', {
  state: (): UserModuleType => ({
    ...
    avatar:
      getStore({ name: 'avatar' }) ||
      require('@/assets/cropper_images/user.gif'),
  }),
  getters: {
  ...
  actions: {
    ...
    async login(userInfo: any) {
      ...
      this.setNickName(data.user.nickName)
      this.setAvatar(data.user.headerImg)
      // console.log('data====', data.user.headerImg, this.avatar)
