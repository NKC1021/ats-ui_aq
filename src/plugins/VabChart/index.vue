...
<script>
  ...
  import { theme } from './theme/aqsEchartsTheme.js'
  ...
  export default defineComponent({
    ...
    mounted() {
      if (this.option) {
        ...
        echarts.registerTheme('aqs-echarts-theme', theme[echartsThemeName])
        this.init()
      }
    },
    activated() {
      ...
      init(option) {
        ...
        Object.keys(this.$attrs).forEach((event) => {
          ...
          chart.on('dblclick', (params) => {
            this.$emit('chart-dbl-click', params)
          })
        })
        if (this.autoResize) {
