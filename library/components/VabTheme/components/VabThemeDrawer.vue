<script lang="ts" setup>
  ...
  const updateEChartsTheme = async () => {
    await saveTheme()
  ...
  const randomTheme = async () => {
    ...
    theme.value.echartsThemeName = shuffle(theme.value.echartsThemeName, [
      'aqsDefault',
      'vintage',
      'dark',
      'westeros',
      ...
      <el-form ref="form" label-position="left" :model="theme">
        ...
        <el-form-item>
          <template #label>
            {{ translate('图表主题') }}
            <el-tooltip
              :content="translate('改变柱状图、折线图等图表的主题样式')"
              effect="dark"
              placement="top"
            >
              <vab-icon icon="question-line" />
          ...
          <el-select
            v-model="theme.echartsThemeName"
            @change="updateEChartsTheme"
          >
            <el-option key="aqsDefault" label="aqsDefault" value="aqsDefault" />
            <el-option key="vintage" label="vintage" value="vintage" />
            <el-option key="dark" label="dark" value="dark" />
            <el-option key="westeros" label="westeros" value="westeros" />
            <el-option key="essos" label="essos" value="essos" />
            <el-option key="wonderland" label="wonderland" value="wonderland" />
            <el-option key="walden" label="walden" value="walden" />
            <el-option key="chalk" label="chalk" value="chalk" />
            <el-option
              key="infographic"
              label="infographic"
              value="infographic"
            />
            <el-option key="macarons" label="macarons" value="macarons" />
            <el-option key="roma" label="roma" value="roma" />
            <el-option key="shine" label="shine" value="shine" />
            <el-option
              key="purple-passion"
