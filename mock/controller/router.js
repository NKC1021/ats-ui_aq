    ...
    children: [
      {
        path: 'personalCenter',
        name: 'PersonalCenter',
        component: '@/views/user/personalCenter/index',
        meta: {
          title: '个人中心',
      ...
      },
      {
        path: 'userManagement',
        name: 'UserManagement',
        component: '@/views/user/userManagement/index',
        meta: {
          title: '用户管理',
          icon: 'user-3-line',
        },
      },
      {
        path: 'roleManagement',
        name: 'RoleManagement',
        component: '@/views/user/roleManagement/index',
        meta: {
          title: '角色管理',
          icon: 'admin-line',
        },
      },
      {
        ...
        component: '@/views/user/departmentManagement/index',
        meta: {
          title: '部门管理',
          icon: 'group-line',
        },
      },
      {
        path: 'menuManagement',
        name: 'MenuManagement',
        component: '@/views/user/menuManagement/index',
        meta: {
          title: '菜单管理',
          icon: 'menu-2-fill',
        },
      },
      {
        ...
        component: '@/views/user/dictionaryManagement/index',
        meta: {
          title: '字典管理',
          icon: 'book-2-line',
          dot: true,
      ...
      },
      {
        path: 'taskManagement',
        name: 'TaskManagement',
        component: '@/views/user/taskManagement/index',
        meta: {
          title: '任务管理',
          icon: 'task-line',
          badge: 'New',
      ...
      },
      {
        path: 'systemLog',
        name: 'SystemLog',
        component: '@/views/user/systemLog/index',
        meta: {
          title: '系统日志',
